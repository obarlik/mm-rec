...
#include "mm_rec/training/training_config.h" // Extracted
...
// TrainingBatch and TrainingConfig moved to training_config.h
...
private:
    ...
    std::shared_ptr<IOptimizerFactory> optimizer_factory_;
